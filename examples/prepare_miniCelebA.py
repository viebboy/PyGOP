...
"""
    ...
    for split in ['train', 'val', 'test']:
        ...
        if not os.path.exists(os.path.join(dst, 'x_' + split + '.npy')) or not os.path.exists(os.path.join(dst, 'y_' + split + '.npy')):
            ...
            assert count == no_sample , "number of sample (%d) is different than number of read image (%d)" % (no_sample, count)
