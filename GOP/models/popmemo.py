    ...
    def progressive_learn(self,
        ...
        if not train_states['is_finished']:
            for layer_iter in range(train_states['layer_iter'], len(params['max_topology'])):
                ...
                m_results = gop_utils.calculate_memory_block_standalone(params,
                                                                        train_states,
                                                                        train_func,
                                                                        train_data,
                                                                        val_func,
                                                                        ...
                                                                        test_func,
                                                                        test_data)
                pre_bn_weight, projection, post_bn_weight = m_results
                ...
                s_results = search_routine(params,
                                           train_states,
                                           train_func,
                                           train_data,
                                           val_func,
                                           ...
                                           test_func,
                                           test_data)
                block_performance, block_weights, block_op_set_idx, history = s_results
