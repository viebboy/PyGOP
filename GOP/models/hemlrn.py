...
# -*- coding: utf-8 -*-
"""
Heterogeneous Multilayer Randomized Network based Generalized Operational Perceptron
...
class HeMLRN(_Model):
    """Heterogeneous Multilayer Randomized Network (HeMLRN) model
    
    This class implements the HeMLRN algorithm to learn a heterogeneous multilayer 
    ...
    without intermediate finetuning as in HeMLGOP. 
    ...
    Examples:
        ...
        >>> model = models.HeMLRN() # create a model instance
        ...
        # save model to 'hemlrn.pickle'
        >>> model.save('hemlrn.pickle')
        
        # load model from 'hemlrn.pickle' and finetune with another data and
        # (possibly different) parameter settings
        >>> model.load('hemlrn.pickle')
